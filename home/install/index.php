...
if(!@include_once(S_ROOT.'./config.php')) {
	@include_once(S_ROOT.'./gohooh.com.config.php');
	show_msg('Vui lòng sửa file "gohooh.com.config.php" trong thư mục "home" thành "config.php"', 999);
}
...
END;
	...
	show_msg('<font color="red">Chúc mừng! Bạn đã cài đặt UCenter Home việt hóa bởi <a href="http://www.gohooh.com/" target="_blank">GoHooH.CoM</a> - Trang web hỗ trợ chính thức của Ucenter Home tại Việt Nam.</font>
		<br>Để tiếp tục cài đặt full mod bạn hãy làm theo hướng dẫn:<br><br>	
		<br><h2>Click vào <a href="./gohooh.com.php"><font color="red">đây</font></a> để tiếp tục.</h2>', 999);
}
...
if(empty($step)) {
	...
	Gói Ucenter Home được Việt hóa hoàn toàn bởi <a href="http://www.gohooh.com/forum/" target="_blank">GoHooH.CoM</a> - Trang web chính thức hỗ trợ Discuz, Ucenter Home...tại Việt Nam. (có 1 file js từ ndvmedia). Mong các bạn tôn trong quyền tác giả để tiếp tục hoàn chỉnh bản Việt hóa.
...
END;
		...
		if(!$ucfounderpw) {
			$plus = '<tr><td id="msg2">
					Việc sử dụng các UCenter Home cần phải cài đặt UCenter.<br>
					...
					2. Liên hệ Y!M: quannguyenphat hoặc vào <a href="http://www.gohooh.com/forum/" target="_blank">http://www.gohooh.com/forum/</a> để được hỗ trợ tốt nhất. <br>
				</td></tr>';
		}
		print<<<END
		<form id="theform" method="post" action="$theurl">
...
END;
	...
	<tr><td id="msg1"><a href="http://www.gohooh.com/forum/thread-13927-1-1.html" target="_blank">Xem hướng dẫn</a></td></tr>
	</table>
	<table class=datatable>
	<tr>
	...
	<td>Điền chính xác tên csdl</td>
	</tr>
	<tr>
	<td>Tiền tố:</td>
	<td><input type="text" name="db[tablepre]" size="20" value="uchome_"></td>
	<td>Mặc định là uchome_ (<a href="http://www.gohooh.com/forum/thread-13927-1-1.html" target="_blank" title="Giữ nguyên giá trị mặc định để đảm bảo việc cài đặt game, plugins...sau này dễ dàng">?</a>)</td>
	</tr>
	</table>
...
function show_footer() {
	...
	<div id="footer">&copy; Comsenz Inc. 2001-2009 - Việt hóa bởi <a href="http://www.gohooh.com/">GoHooH.CoM</a></div>
	</div>
	<br>
	</body>
	</html>
