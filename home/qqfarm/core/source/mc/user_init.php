...
//写入数据库
$_QFG['db']->query("INSERT INTO app_qqfarm_mc(uid,status,taskid,exp,feed,decorative,parade,badnum,zong) VALUES(" . $_QFG['uid'] . ",'" . qf_encode($status) . "','" . $taskid . "','" . $exp . "','" . qf_encode($feed) . "','" . qf_encode($decorative) . "','" . qf_encode($parade) . "',25,100)");
