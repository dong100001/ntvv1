...
//把花束放入对方花篮^_^
$flower = $_QFG['db']->result("SELECT flower FROM app_qqfarm_nc where uid=" . intval($_REQUEST['to']));
...
$_QFG['db']->query("UPDATE app_qqfarm_nc set flower = '" . qf_encode($flower) . "', nc_e=13 where uid=" . $_REQUEST['to']);
