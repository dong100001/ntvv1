...
if($status[$place]['bitmap']==0 || empty($status[$place]['bitmap'])) {
	if(in_array($cid, array(201,202,126,204,218,219,220,221,222,223,224,225,226,227,228,229))) {
		die( '{"cId":' . $cid . ',"farmlandIndex":' . $place . ',"code":0,"poptype":1,"direction":"高级种子只能种在红土地！"}');
	}
}
...
echo '{"cId":' . $status[$place]['a'] . ',"farmlandIndex":' . $place . ',"code":1,"poptype":0,"direction":"","exp":2,"levelUp":' . $levelup_arr . '}';
