...
//参数入库
$_QFG['db']->query("INSERT INTO app_qqfarm_nc(uid,tips,status,exp,decorative,healthmode,zong) VALUES({$_QFG['uid']},'" . qf_encode($Tips) . "','" . qf_encode($status) . "',{$exp},'" . qf_encode($decorative) . "','" . qf_encode($healthmode) . "',150)");
//Feed推送
