		...
		theImages[i].onload = function() {
			if (this.width > size) {
				...
				if (this.parentNode.tagName.toLowerCase() != 'a') {
					...
					this.title = 'Click vào ảnh để xem kích thước thật ở cửa sổ mới';
...
function setCopy(_sTxt){
	if(is_ie) {
		...
		alert ("Website "+_sTxt+" \n đã được lưu vào bộ nhớ \n Bây giờ bạn có thể gửi cho bạn bè bằng cách nhấn CTR+V");
	} else {
		prompt("Copy địa chỉ website",_sTxt);
	}
}
