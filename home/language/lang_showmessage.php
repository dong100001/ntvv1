...
//tuy chinh
'm_commend_success' => 'Gửi nhạc thành công!',
'm_commendedit_success' => 'Sửa bình luận thành công!',
'm_newmymusicalbum_success' => 'Thêm album mới thành công!',
'nomusic' => 'Nhạc không tồn tại',
'deletemusic_success' => 'Xóa nhạc thành công!',
'deletemusicalbum_success' => 'Xóa album thành công!',
'musicpingfen_success' => 'Thêm điểm thành công!',
'musicpinglun_success' => 'Bình luận thành công!',
'musicsetbg_success' => 'Cài đặt thành công!',
	...
	'enter_the_correct_class_name' => 'Vui lòng nhập tên chuyên mục',
...
~Thăm dò ý kiến thành viên và chia sẻ liên kết <br><br><a href="cp.php?ac=mtag" class="submit">Tạo nhóm mới</a>',
	...
	'magicuse_not_enough_credit' => 'Không đủ tiền!',
	...
	'email_unchecked' => 'Email chưa kich hoạt. <a href="cp.php?ac=profile&op=contact">Kích hoạt ngay</a>',
