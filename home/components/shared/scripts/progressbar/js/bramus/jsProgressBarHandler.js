  ...
  */
 	...
 	// Default Options
		var defaultOptions = {
			...
			boxImage	: 'components/shared/scripts/progressbar/images/bramus/percentImage2.png',			// boxImage : image around the progress bar
			barImage	: 'components/shared/scripts/progressbar/images/bramus/percentImage_back5.png',	// Image to use in the progressbar. Can be an array of images too.
		...
		JS_BRAMUS.jsProgressBar.prototype = {
			 ...
			 */
				initialize		: function(el, percentage, options) {
					...
					this.el.update(
						'<img id="' + this.id + '_percentImage" src="' + this.options.boxImage + '" alt="0%" style="width: ' + this.options.width + 'px; height: ' + this.options.height + 'px; background-position: ' + this.initialPos + 'px 50%; background-image: url(' + this.options.barImage[this.backIndex] + '); padding-left: 0; margin: 0;"/>' + 
