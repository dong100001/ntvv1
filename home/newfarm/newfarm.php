...
if ( $maxuid == NULL )
{
				...
				$icon = "farm";
				$title_template = "{actor} chơi game nông trại vui vẻ <a href=\"newfarm.php\">Newfarm</a> ở <a target=\"blank\" href=\"http://www.gohooh.com/nhatui\">Nhà Tui</a>";
				$body_general = "Tham gia vào hội nông dân Nhà Tui để có thêm nhiều bạn mới!";
