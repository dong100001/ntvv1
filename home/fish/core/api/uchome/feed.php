...
function qf_addFeed2($type) {
	...
	switch($type) {
		case 'user_init':
			$title_template = "{$actor} tham gia <a href='fish.php'>ao cá vui vẻ</a> trên mạng xã hội <a target='blank' href='htp://www.gohooh.com/nhatui/'>Nhà Tui</a>.";
			$body_general = "Ao cá vui vẻ cực kỳ thú vị!";
			break;
		case 'landstaus_clearweed1':
			$title_template = "{$actor} chăm sóc <a href='fish.php'>ao cá vui vẻ</a> trên mạng xã hội <a target='blank' href='htp://www.gohooh.com/nhatui/'>Nhà Tui</a>";
			$body_general = "Hãy trở thành 1 ngư dân thực thụ!";
			break;
		case 'fishlandstaus_clearweed2':
			$title_template = "{$actor} ghé thăm <a href='fish.php'>ao cá</a> của {$touser} trên mạng xã hội <a target='blank' href='htp://www.gohooh.com/nhatui/'>Nhà Tui</a>";
		...
		case 'fishlandstatus_spraying2':
			$title_template = "{$actor} ghé thăm {$touser} 的 <a href='fish.php'>ao cá vui vẻ</a>  trên mạng xã hội <a target='blank' href='htp://www.gohooh.com/nhatui/'>Nhà Tui</a>。";
			$body_general = "Thêm bạn thêm vui!";
			break;
